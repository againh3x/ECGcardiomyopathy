...
#   • All tasks use L1-penalised Logistic-Regression.
...
# ─── CONFIG ────────────────────────────────────────────────────────────────
DATA_PATH     = Path("table_data_filtered.csv")
RANDOM_STATE  = 42
...
SELECTED_10_FEATURES = [
    "R_S_ratio_I", "R_S_ratio_aVR", "mean_S_aVR", "mean_S_II", "mean_R_aVR",
    "qrs_end", "angle_e1_QRS_T_deg", "T_wave_dipolar_ln_mV",
...
df_full = (
    pd.read_csv(DATA_PATH)
      ...
      .drop(columns=[
          ...
          "Atrial Fibrillation","Atrial Flutter","LBBB","RBBB","LAFB","LPFB","PVC"
      ], errors="ignore")
      .copy()
)
